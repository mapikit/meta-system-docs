...
As you can see, you can easily modify the behavior of your system in just a few minutes! This is the power of Meta-System. Now, if you truly want to do wonders with this tool, you can keep playing around with this example config and when you are done head to the [Configuration Section](./configuring/basics) to learn all nooks and crannies of the Meta-System Configuration, and make your ideas come to life!
