...
### First Steps
The Meta-System can be downloaded through [NPM](https://www.npmjs.com/). If you have NodeJs installed you probably already have npm and it is a matter of installing with the command
