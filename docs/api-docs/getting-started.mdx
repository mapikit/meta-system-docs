...
Now, that you have installed Meta-System and have a configuration ready to go, all there is to do is run the command:
...
Cool, right? Let's now touch on what every bit of this file is doing!
