...
# Meta-System
<img src="/meta-system-docs/img/docs/v04_Andromeda_launch.png" style={{ height:"auto", width:"100%", objectFit:"contain" }}/>
...
<details>
  <summary><b>Click to Show Example Config
</b></summary>
...
Want to know more about this fizz-buzz example? How it is like it is? Lets head to [it's tutorial page](../tutorials/fizz-buzz) to know more!
